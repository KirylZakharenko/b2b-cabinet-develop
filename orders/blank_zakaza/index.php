...
Asset::getInstance()->addCss(SITE_TEMPLATE_PATH . "/assets/css/jquery.floatingscroll.css");
Asset::getInstance()->addJs(SITE_TEMPLATE_PATH . "/assets/js/plugins/jquery/jquery.floatingscroll.js");
...
$APPLICATION->IncludeComponent(
    ...
    array(
        ...
        "BASKET_URL" => "/orders/make/",
        "LIST_SHOW_MEASURE_RATIO" => "Y",
        "DETAIL_MAIN_ARTICLE_PROPERTY" => "",
        "DETAIL_MAIN_BRAND_PROPERTY" => "",
        "DETAIL_MAIN_FILES_PROPERTY" => "",
        "SHOW_SKU_DESCRIPTION" => "N",
        "ARTICLE_PROPERTY" => "CML2_ARTICLE",
        "SEF_FOLDER" => "/orders/blank_zakaza/",
        "STORES" => array(
            0 => "1",
            1 => "",
        ),
