...
if (is_array($arElements)) {
    ...
    if (isset(${$arParams[1]['FILTER_NAME']}['ID']) && !empty(${$arParams[1]['FILTER_NAME']}['ID'])) {
        ${$arParams[1]['FILTER_NAME']}['ID'] = array_intersect(${$arParams[1]['FILTER_NAME']}['ID'], $arElements);
    } else {
        ${$arParams[1]['FILTER_NAME']}['ID'] = $arElements;
    }
    if (isset(${$arParams[1]['FILTER_NAME']}['ID']) && empty(${$arParams[1]['FILTER_NAME']}['ID'])) {
        ${$arParams[1]['FILTER_NAME']}['ID'] = [0];
    }
}
if ($_REQUEST['q']) {
