...
?>
        <a class="favorite_link" href="<?=htmlspecialcharsbx($linkParam["URL"])?>">
            ...
            <i class="ph-x me-1 fs-sm gdfavdellink" style="display: none;" onclick="Del<?=$rnd?>('<?=$i?>'); return false;"></i>
        </a>
	</div>
<?endforeach?>
</div>
    ...
    <div id="gdfavoriteslink2<?=$rnd?>" style="display: none;" class="widget_content widget_links_btns gdfavaddlink">
        <a href="javascript:void(0)"  onclick="return EditMode<?=$rnd?>(false);"><?echo \Bitrix\Main\Localization\Loc::getMessage("GD_FAVORITES_CH_EXIT")?></a>
    </div>


    <div id="gdfavoriteslink<?=$rnd?>" class="widget_links_btns gdfavaddlink">
        <a class="main-link b2b-main-link" href="javascript:void(0)" onclick="return ShowHide<?=$rnd?>(true);"><?echo \Bitrix\Main\Localization\Loc::getMessage("GD_FAVORITES_ADD")?></a><span> | </span>
        <a class="main-link b2b-main-link" href="javascript:void(0)" onclick="return EditMode<?=$rnd?>(true);"><?echo \Bitrix\Main\Localization\Loc::getMessage("GD_FAVORITES_CH")?></a>
    </div>
...
<form action="<?=$arParams["UPD_URL"]?>" method="post">
    ...
    <div class="widget_content widget_links">
        <div class="form-group form-group-float">
            <label><?echo \Bitrix\Main\Localization\Loc::getMessage("GD_FAVORITES_NEW_URL")?></label>
            <input type="text" class="form-control" value="http://" name="url">
        </div>
        <div class="form-group form-group-float">
            <label><?echo \Bitrix\Main\Localization\Loc::getMessage("GD_FAVORITES_NAME")?></label>
            <input type="text" name="name" class="form-control">
        </div>
    </div>

    <div class="widget_content widget_links_btns">
        <input type="submit" class="button_link" name="gdfvadd" value="<?echo \Bitrix\Main\Localization\Loc::getMessage("GD_FAVORITES_ADD_URL")?>">
        <span> | </span>
        <input type="button" class="button_link" value="<?echo \Bitrix\Main\Localization\Loc::getMessage("GD_FAVORITES_CANCEL_URL")?>" onclick="ShowHide<?=$rnd?>(false);">
    </div>
</form>
</div>
<?
