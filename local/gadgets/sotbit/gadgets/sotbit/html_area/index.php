...
<?if($arParams["PERMISSION"]>"R"):?>
<div class="widget_links_btns" style="padding-top: 10px;"><a class="main-link b2b-main-link" href="javascript:void(0);" onclick="gdhtmledit()"><?echo GetMessage("GD_HTML_AREA_CHANGE_LINK")?></a></div>
<?endif?>
</div>
...
?>
	...
	<?endif;?>
	<?=bitrix_sessid_post()?>
	<a class="btn btn-sm btn-flat-primary" href="javascript:void(0);" onclick="return gdhtmlsave();"><?echo GetMessage("GD_HTML_AREA_SAVE_LINK")?></a> <a class="btn btn-sm btn-flat-danger" href="<?=$GLOBALS["APPLICATION"]->GetCurPageParam(($arParams["MULTIPLE"]=="Y"?"dt_page=".$arParams["DESKTOP_PAGE"]:""), array("dt_page","gdhtml","edit"))?>"><?echo GetMessage("GD_HTML_AREA_CANCEL_LINK")?></a>
</form>
