$(document).ready(function(){
    ...
    const modal = document.querySelector('#modal-staff-register'),
        modalDialog = modal.querySelector('.modal-dialog .modal-content'),
        ...
        confirmDialog = confirmForm.querySelector('.modal-dialog .modal-content'),
        ...
        referralModalDialog = referralModal.querySelector('.modal-dialog .modal-content'),
    ...
    function closeModal(modal) {
        ...
        $('#modal-staff-register .form-control.select').val(null).trigger('change');
        modal.querySelector('[data-bs-dismiss="modal"]').click();
    }
});