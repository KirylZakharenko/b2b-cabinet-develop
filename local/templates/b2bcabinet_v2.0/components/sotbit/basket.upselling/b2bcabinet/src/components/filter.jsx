                ...
                <div className="filter__body-wrapper">
                        ...
                        <label className='filter-selected-multiple'>
                            <div className="filter__selected-section">
                                ...
                                <input
                                    ...
                                    onBlur={(e) => {e.target.style.width = 'auto';setSectionsSelectVisible(false)}}
                                    value={sectionsName}
                                    onChange={e => {e.target.style.width = e.target.value.length ? (e.target.value.length * .75 + 'em') : 'auto';setSectionName(e.target.value)}}
                    ...
                    <div className="filter__input-group">
                        <div className='form-control-feedback form-control-feedback-end'>
                            <input
                                type="text"
                                className="filter__input form-control form-control-sm"
