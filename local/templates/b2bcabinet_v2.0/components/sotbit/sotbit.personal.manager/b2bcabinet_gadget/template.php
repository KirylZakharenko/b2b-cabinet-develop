...
<div class="b2b-personal-manager">
    <div class="card-img-actions d-inline-block mb-3">
        <img class="img-fluid rounded-circle object-fit-cover w-100 h-100" src="<?=!empty($arResult['PERSONAL_PHOTO']['src']) ? $arResult['PERSONAL_PHOTO']['src'] : SITE_TEMPLATE_PATH . '/assets/images/acc_manager.svg'?>" width="135" height="135" alt="<?=$arResult['NAME_FORMATTED']?>">
