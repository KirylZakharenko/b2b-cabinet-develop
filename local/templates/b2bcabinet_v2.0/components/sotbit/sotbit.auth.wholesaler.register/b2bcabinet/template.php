        ...
        <div class="col-md-12">
            <div class="card card-body text-center">
                ...
                <div class="text-center w-sm-75 mx-auto">
                    <? echo Loc::getMessage("CONFIRM_REGISTRATION") ?>
                    <div>
        ...
        <div class="card-body pt-0">
            <div class="chouse-company mb-4">
                ...
                <? if ($arResult["PERSONAL_GROUPS_LIST"]): ?>
                    <label class="d-block font-weight-semibold"><?= $arResult["PERSONAL_GROUPS_LIST_TITLE"] ?: Loc::getMessage('PERSONAL_GROUPS_LIST_TITLE') ?></label>
                    ...
                    <form id="person_group_check" method="post">
                        <? foreach ($arResult["PERSONAL_GROUPS_LIST"] as $groupId => $arGroup): ?>
                            <div class="form-check form-check-inline">
                                ...
                                >
                                <label class="form-check-label" for="PERSONAL_GROUP_<?=$groupId?>"><?= $arGroup['VALUE']; ?></label>
                            </div>
                        <? endforeach; ?>
                    </form>
                <? endif; ?>
                    ...
                    <form method="post" action="<?= POST_FORM_ACTION_URI ?>" class="flex-fill"
                        ...
                        <div class="mb-4">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <label class="form-label"><?= Loc::getMessage("REGISTER_FIELD_NAME") ?>: <span class="req">*</span>
                                    </label>
                                    <div class="form-control-feedback form-control-feedback-end mb-2">
                                        <input required
                                                type="text"
                                    ...
                                    if (in_array($FIELD, ['PASSWORD', 'CONFIRM_PASSWORD', 'EMAIL', 'LOGIN', 'NAME', 'LAST_NAME'])) {
                                        ...
                                        <div class="col-md-12">
                                            <label class="form-label"><?
                                                ...
                                                <?= in_array($FIELD, 
                                                    is_array($arResult['OPT_FIELDS_REQUIRED'][$group['ID']]) ? $arResult['OPT_FIELDS_REQUIRED'][$group['ID']] : []) ? '<span class="req">*</span>' : '' ?>
                                            </label>
                                    ...
                                    <div class="col-md-12">
                                        <? foreach ($arResult['OPT_ORDER_FIELDS'][$group['ID']] as $order): ?>
                                            ...
                                            <? if (is_array($order['CODE']) && $order['CODE']['FILE'] == 'Y'): ?>
                                                <label class="form-label">
                                                    <?= Loc::getMessage("REGISTER_FIELD_FILES") ?>
                                                </label>
                                                <?
                                                $APPLICATION->IncludeComponent(
...
<script>
    var companyRegisterAgreementInput = 'UF_CONFIDENTIAL' //'<?=$arResult["AGREEMENT_INPUT_NAME"]?>';
    var siteDir = '/';
</script>