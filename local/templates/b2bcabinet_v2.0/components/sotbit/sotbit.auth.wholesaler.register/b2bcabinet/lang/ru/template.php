...
$MESS["AUTH_COMMON_BLOCK_TITLE"] = "Основные данные";
...
$MESS["REGISTER_FIELD_PHONE_TO_REGISTER"] = "Телефон для регистрации";
...
$MESS["REGISTER_FIELD_FILES"] = "Добавить файлы:";
$MESS["REGISTER_EMAIL_WILL_BE_SENT"] = "На указанный в форме e-mail придет запрос на подтверждение регистрации.";
$MESS["MAIN_REGISTER_AUTH"] = '<h6 class="m-0 font-weight-semibold">Вы зарегистрированы на сайте и успешно авторизованы.</h6>';
...
$MESS["CONFIRM_REGISTRATION"] = '<h6 class="m-0 font-weight-semibold">Спасибо за регистрацию.</h6><p class="mb-3 text-muted">Ожидайте подтверждение модератором.</p>';
...
$MESS["REGISTER_SUCCESS_BTN"] = 'Войти';
$MESS["REGISTER_BTN_MULTIPLE"] = 'Добавить';
$MESS["REGISTER_FIELD_PLACEHOLDER"] = 'Введите #FIELD#';
