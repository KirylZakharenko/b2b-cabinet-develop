...
if (CModule::IncludeModule('sotbit.complaints') && SotbitComplaints::getIncludeComplaints()) {
    ...
    <div class="blank_detail">
        <div class="detail-menu d-flex justify-content-between align-items-center overflow-auto">
            <ul class="nav nav-tabs nav-mainpage-tabs">
                <li class="nav-item">
                    <a href="#basic-tab1" class="nav-link active show" data-bs-toggle="tab"
                        onclick="writeActiveTab('#basic-tab1')"><?= Loc::getMessage('SPOD_TAB_COMMON') ?></a>
                </li>
                <li class="nav-item">
                    <a href="#basic-tab2" class="nav-link" data-bs-toggle="tab"
                        onclick="writeActiveTab('#basic-tab2')"><?= Loc::getMessage('SPOD_TAB_GOODS') ?></a>
                </li>
                <li class="nav-item">
                    <a href="#basic-tab3" class="nav-link" data-bs-toggle="tab"
                        onclick="writeActiveTab('#basic-tab3')"><?= Loc::getMessage('SPOD_TAB_DOCS') ?></a>
                </li>
                <li class="nav-item">
                    <a href="#basic-tab4" class="nav-link" data-bs-toggle="tab"
                        onclick="writeActiveTab('#basic-tab4')"><?= Loc::getMessage('SPOD_TAB_PAYS') ?></a>
                </li>
                <li class="nav-item">
                    <a href="#basic-tab5" class="nav-link" data-bs-toggle="tab"
                        onclick="writeActiveTab('#basic-tab5')"><?= Loc::getMessage('SPOD_TAB_SHIPMENTS') ?></a>
                </li>
                <li class="nav-item">
                    <a href="#basic-tab6" class="nav-link" data-bs-toggle="tab"
                        onclick="writeActiveTab('#basic-tab6')"><?= Loc::getMessage('SPOD_TAB_SUPPORT') ?></a>
                </li>
                <?if ($complaintsType == "ORDER" && !empty($arResult['COMPLAINTS_ROW'])) {?>
                    <li class="nav-item">
                        <a href="#basic-tab7" class="nav-link" data-bs-toggle="tab"
                                                    ...
                                                    <div class="card-content__row">
                                                        ...
                                                        <dd>
                                                            ...
                                                            if ($orderProp['MULTIPLE'] == "Y") {
                                                                $orderProp['VALUE'] = implode("<br>", array_diff(unserialize($orderProp['VALUE']), [""]));
                                                            }
                                                            ?>
                                                            <?= $orderProp['VALUE'] ?>
                                                        </dd>
                    ...
                    $APPLICATION->IncludeComponent(
                        ...
                        array(
                            ...
                            'HEADERS' => array(
                                ...
                                array(
                                    "id" => "SUM",
                                    "name" => Loc::getMessage('SOPC_COMPLAINTS_SUM'),
                                    "sort" => "SUM",
                                    "default" => true
                                ),
                                array(
                                    "id" => "COMPANY",
                                    "name" => Loc::getMessage('SOPC_COMPLAINTS_COMPANY'),
                                    "sort" => "COMPANY",
                                    "default" => true
                                )
                            ),
