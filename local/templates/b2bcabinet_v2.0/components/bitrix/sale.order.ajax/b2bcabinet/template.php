...
else
{
	...
	<form action="<?=POST_FORM_ACTION_URI?>" method="POST" name="ORDER_FORM" id="bx-soa-order-form" enctype="multipart/form-data">
		...
		<div id="bx-soa-order" class="row bx-<?=$arParams['TEMPLATE_THEME']?>" style="opacity: 0">
			<!--	MAIN BLOCK	-->
			<div class="col-xxl-9 col-xl-8 col-lg-8 bx-soa-make">
				...
				<div id="bx-soa-auth" class="bx-soa-section bx-soa-auth" style="display:none">
					<div class="bx-soa-section-title-container row">
						<h5 class="bx-soa-section-title col-sm-9">
				...
				<div class="d-lg-none bx-mobile-order">
					<div class="bx-soa-cart-total-title gradient-modal text-white">
						<h5 class="bx-soa-section-title mb-0">
							<?=Loc::getMessage('CART_TITLE')?>
						</h5>
					</div>
					<div class="bx-soa-section pt-3 pb-3">
						<div id="bx-soa-total-mobile" class="bx-soa-section-content"></div>
					</div>
				</div>
				...
				<? if ($arParams['BASKET_POSITION'] === 'before'): ?>
					...
					<div id="bx-soa-basket" data-visited="false" class="bx-soa-section bx-active">
						<div class="bx-soa-section-title-container row">
							<h5 class="bx-soa-section-title col-sm-12">
			...
			<!--	SIDEBAR BLOCK	-->
			<div id="bx-soa-total" class="col-xxl-3 col-xl-4 col-lg-4 d-none d-lg-flex">
				<div class="bx-soa-sidebar">
					<div class="bx-soa-cart-total-ghost"></div>
					<div class="bx-soa-cart-total-title gradient-modal text-white"><?=Loc::getMessage('CART_TITLE')?></div>
