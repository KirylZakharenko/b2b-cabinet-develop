...
)
{
	...
	$arResult["User"]["PersonalPhotoImgThumbnail"]["Image"] = '<img src="'. $path .'" width="'.$arParams["THUMBNAIL_LIST_SIZE"].'" height="'.$arParams["THUMBNAIL_LIST_SIZE"].'" border="0" alt="'.($arResult["User"]["NAME"] ? $arResult["User"]["NAME"] : $arResult["User"]["LAST_NAME"]).'">';
}
