            ...
            <aside class="blank-zakaza-detail__aside card">
                <div class="blank-zakaza-detail__info">
                    ...
                    <? if ($arResult['PRODUCT']['TYPE'] !== 3): ?>
                        <? if ($arParams['SHOW_MAX_QUANTITY'] !== "N") { ?>
                            <div class="blank-zakaza-detail__info-item">
                                <span>
                                    ...
                                    --><? if ($arResult['CATALOG_MEASURE_RATIO'] != 1 || $arParams['SHOW_MAX_QUANTITY'] !== 'M') {
                                        echo '(' . Loc::getMessage('PRODUCT_LABEL_MEASURE', [
                        ...
                        <div class="blank-zakaza-detail__info-item bzd-quantity">
                            <?
                            ...
                            <div class="bootstrap-touchspin bootstrap-touchspin-lg input-group" id="<?= $itemIds['QUANTITY'] ?>">
                                <span class="input-group-btn input-group-prepend">
                                    <button class="btn bootstrap-touchspin-down"
                                            ...
                                            title="<?= Loc::getMessage("PRODUCT_BTN_DECREMENT") ?>"
                                ...
                                <span class="input-group-btn input-group-append">
                                    <button class="btn bootstrap-touchspin-up"
                                            type="button"
                                            title="<?= Loc::getMessage("PRODUCT_BTN_INCREMENT") ?>"
                                            ...
                                            <td class="bzd-offers__offer-cell">
                                                <div class="product__quant" id="prod_qu_<?= $offer['ID'] ?>">
                                                    ...
                                                    <span class="title-quant">
                                                        <?= Loc::getMessage('PRODUCT_LABEL_MEASURE_NAME', ["#CATALOG_MEASURE_NAME#" => $arParams['SHOW_MAX_QUANTITY'] !== 'M' ? $offer['CATALOG_MEASURE_NAME'] : '']); ?>
                                                    </span>
                                                </div>
                                ...
                                <div class="bzd-gallery__item">
                                    <div class="bzd-gallery__image-wrapper">
                                        <a class="lightbox-toggle" data-gallery="product" href="<?= $image['BIG_IMAGE']['src'] ?>" data-bs-toggle="lightbox">
                                            <img class="bzd-gallery__image mw-100 mh-100 h-auto w-auto m-auto top-0 end-0 bottom-0 start-0 img-fluid" src="<?= $image['SMALL_IMAGE']['src'] ?>"
                                                title="<?= $name ?>" alt="<?= $name ?>">
                                        </a>
                                    </div>
                                </div>
                ...
                <? if (
                    ...
                    <?$APPLICATION->IncludeComponent(
                        ...
                        array(
                            ...
                            "SECTION_NAME" => Loc::getMessage('CROSSSELL_SECTION_NAME'),
                            ...
                            "BASE_QUANTITY" => $offer['CATALOG_QUANTITY'],
                            "SHOW_EMPTY_STORE" => $arParams['SHOW_EMPTY_STORE'],
                            "OFFERS_VIEW" => \Bitrix\Main\Config\Option::get('sotbit.b2bcabinet', 'CATALOG_VIEW_OFFERS_VALUE', 'BLOCK', SITE_ID),
                            "LAZY_LOAD" => 'Y',
                            "LOAD_ON_SCROLL" => 'Y',
