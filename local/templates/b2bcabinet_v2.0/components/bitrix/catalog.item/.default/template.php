...
$jsParams = array(
    ...
    'PRODUCT' => array(
        ...
        'CATALOG_QUANTITY_TRACE' => $item['CATALOG_QUANTITY_TRACE'],
        'CATALOG_CAN_BUY_ZERO' => $item['CATALOG_CAN_BUY_ZERO'],
        'PRINT_PRICES' => $item['PRINT_PRICES'],
        'ACTUAL_QUANTITY' => $item['ACTUAL_QUANTITY'],
        'CATALOG_MEASURE_RATIO' => $item['CATALOG_MEASURE_RATIO'],
                ...
                case 'OFFERS':
                                            ...
                                            if ($skuProperty['SHOW_MODE'] === 'PICT') {
                                                ...
                                                <li class="product-item-scu-item-container" title="<?=$value['NAME']?>"
                                                    ...
                                                    <div class="product-item-scu-item-block">
                                                        <img src="<?= $value['PICT']['SRC'] ?: SITE_TEMPLATE_PATH . '/assets/images/no_photo.svg' ?>" loading="lazy" alt="<?= $value['NAME'] ?>">
                                                    </div>
                                                </li>
                                                <?
                                            } else {
                    ...
                    if ($arParams['OFFERS_VIEW'] === 'BLOCK') {
                        foreach ($item['OFFERS'] as $index => &$offer) {
                            ...
                            $jsParams['PRODUCT']['OFFERS'][$index]['CATALOG_QUANTITY'] = $offer['CATALOG_QUANTITY'];
                        }
                    }
                    ?>
                    <?
                        ...
                        if (!$isOffers) {
                            ...
                            <td class="product__property product__property--avaliable">
                                ...
                                <?
                                    ...
                                    $jsParams['PRODUCT']['CATALOG_QUANTITY'] = $item['CATALOG_QUANTITY'];
                                    ?>
                                    <span class="title-quant">
                                        <?= Loc::getMessage('PRODUCT_LABEL_MEASURE', ["#CATALOG_MEASURE_NAME#" => $arParams['SHOW_MAX_QUANTITY'] !== 'M' ? $item['CATALOG_MEASURE_NAME'] : '']); ?>
                                    </span>
                                </div>
                                <? if($item['CATALOG_MEASURE_RATIO'] != 1):?>
                                    <div class="product__ratio text-nowrap text-muted">
                                        <span class="product-ratio__title"><?= Loc::getMessage('PRODUCT_LABEL_RATIO')?></span>
                                        <span class="product-ratio__value"><?=$item['CATALOG_MEASURE_RATIO']?></span>
                                    </div>
                                <?endif;?>
                            </td>
                            <?
                            ...
                            <td class="product__property product__property--avaliable">
                                <div class="product__quant">
                                    ...
                                    <span class="item-quantity__general">
                                        ...
                                        } elseif ($arParams["OFFERS_VIEW"] === 'LIST') {
                                            echo $item['CATALOG_QUANTITY'];
                                        }
                                        ?>
                                    </span>
                                    <span class="title-quant">
                                        <?= $arParams["OFFERS_VIEW"] === 'LIST' ?
                                            Loc::getMessage('PRODUCT_LABEL_MEASURE', ["#CATALOG_MEASURE_NAME#" => $arParams['SHOW_MAX_QUANTITY'] !== 'M' ? $item['CATALOG_MEASURE_NAME'] : ''])
                                            :
                                            ''; 
                                        ?>
                                ...
                                <div class="product__ratio text-nowrap text-muted">
                                    <span class="product-ratio__title"></span>
                                    <span class="product-ratio__value"></span>
                                </div>
                            </td>
                        <? 
                        }
                            ...
                            <div class="wrap-product__property--price">
                                <? if (!$isOffers): ?>
                                    <span id="<?= $itemIds['PRICES'][$priceCode] ?>">
                                        <?= $item['PRINT_PRICES'][$priceCode][$item['ITEM_QUANTITY_RANGE_SELECTED']]['PRINT']; ?>
                                    </span>
                                        <? if (
                                ...
                                <? else :?>
                                    <span><?=$item['MIN_PRICE'][$priceCode]['PRINT'] ? 
                                        Loc::getMessage('CT_BCI_TPL_MESS_PRICE_SIMPLE_MODE',
                                        [
                        ...
                        <div class="bootstrap-touchspin input-group" id="<?= $itemIds['QUANTITY'] ?>" data-entity="quantity-block">
                            <span class="input-group-btn input-group-prepend">
                                <button class="btn bootstrap-touchspin-down"
                                        ...
                                        aria-label="<?= GetMessage('PRODUCT_BTN_DECREMENT') ?>"
                            ...
                            <input class="touchspin-basic form-control fs-xs"
                                   type="text"
                                   aria-label="<?= GetMessage('PRODUCT_LABEL_QUANTITY') ?>"
                            ...
                            <span class="input-group-btn input-group-append">
                                <button class="btn bootstrap-touchspin-up"
                                        ...
                                        aria-label="<?= GetMessage('PRODUCT_BTN_INCREMENT') ?>"
                                        <?= $USER->IsAuthorized() ? "" : "disabled" ?>>
                                        <i class="ph-plus"></i>
                                </button>
                            </span>
                                ...
                                if ($arParams['SHOW_MAX_QUANTITY'] !== 'N') { ?>
                                    <td class="product__property product__property--avaliable">
                                        <div class="product__quant" id="prod_qu_<?= $offer['ID'] ?>">
                                            ...
                                            ?>
                                            <span class="title-quant">
                                                <?= Loc::getMessage('PRODUCT_LABEL_MEASURE', ["#CATALOG_MEASURE_NAME#" => $arParams['SHOW_MAX_QUANTITY'] !== 'M' ? $offer['CATALOG_MEASURE_NAME'] : '']); ?>
                                            </span>
                                        </div>
                                        <? if($offer['CATALOG_MEASURE_RATIO'] != 1):?>
                                            <div class="product__ratio text-nowrap text-muted">
                                                <span class="product-ratio__title"><?= Loc::getMessage('PRODUCT_LABEL_RATIO')?></span>
                                                <span class="product-ratio__value"><?=$offer['CATALOG_MEASURE_RATIO']?></span>
                                            </div>
                                        <?endif;?>
                                    </td>
                                    <?
...
?>
    <script>
        BX.message({
            ...
            PRODUCT_LABEL_RATIO: '<?=Loc::getMessage('PRODUCT_LABEL_RATIO')?>'
        });
