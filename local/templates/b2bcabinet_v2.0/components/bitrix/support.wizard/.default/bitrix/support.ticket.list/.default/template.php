...
<div class="support_page">
    ...
    $APPLICATION->IncludeComponent(
        ...
        [
            ...
            "TOTAL_ROWS_COUNT" => $arResult['TICKETS_COUNT'],
    ...
    <div class="row mt-3">
        <div class="col-md-6">
            <div class="d-flex align-items-center gap-2">
                <span class="support-lamp-market support-lamp-market-red"></span>
                <span><?= $bADS ? Loc::getMessage("SUP_RED_ALT_SUP") : Loc::getMessage("SUP_RED_ALT_2") ?></span>
            </div>
            <div class="d-flex align-items-center gap-2">
                <span class="support-lamp-market support-lamp-market-yellow"></span>
                <span><?= Loc::getMessage("SUP_YELLOW_ALT_SUP") ?></span>
            </div>
        </div>
        <div class="col-md-6">
            <div class="d-flex align-items-center gap-2">
                <span class="support-lamp-market support-lamp-market-green"></span>
                <span><?= Loc::getMessage("SUP_GREEN_ALT") ?></span>
            </div>
            <? if ($bADS): ?>
                <div class="d-flex align-items-center gap-2">
                    <span class="support-lamp-market support-lamp-market-green-s"></span>
                    <span><?= Loc::getMessage("SUP_GREEN_S_ALT_SUP") ?></span>
                </div>
            <? endif; ?>
            <div class="d-flex align-items-center gap-2">
                <span class="support-lamp-market support-lamp-market-grey"></span>
                <span><?= Loc::getMessage("SUP_GREY_ALT") ?></span>
            </div>
        </div>
    </div>
</div>
