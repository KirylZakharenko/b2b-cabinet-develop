		...
		{{^SHOW_RESTORE}}
			<td class="basket-items-list-item-descriptions">
				<div class="basket-items-list-item-descriptions-inner" id="basket-item-height-aligner-{{ID}}">
					...
					{
						?>
						<div id="baseket-item-checkbox-{{ID}}" class="baseket-checkbox" data-entity="baseket-item-checkbox">
							<svg width="20" height="20" style="display: none;">
								<polyline points="1,6 7,13 15,0"
									style="fill:none;stroke:###;stroke-width:2" />
							</svg>
						</div>
					...
					<div class="basket-item-block-price">
						...
						<div class="basket-item-price-current">
							<span class="basket-item-price-current-text" id="basket-item-sum-price-{{ID}}">
								  {{#SUM_PRICE_FORMATED_NEW}}{{{SUM_PRICE_FORMATED_NEW}}}{{/SUM_PRICE_FORMATED_NEW}}
                        {{^SUM_PRICE_FORMATED_NEW}}{{{SUM_PRICE_FORMATED}}}{{/SUM_PRICE_FORMATED_NEW}}
							</span>
						</div>
