;(function() {
	...
	BX.Sale.BasketComponent = {
		...
		init: function(parameters)
		{
			...
			this.templateSigns = parameters.templateSigns || '';
		...
		AddGroupHeaderActions: function()
		{
			...
			BX.bind(allChecked, 'click', BX.delegate(checkedAllItems, this));
			BX.bind(document.querySelector('.basket-footer [data-entity="basket-gruope-item-checkbox"]'), 'click', BX.delegate(checkedAllItems, this));

			function checkedAllItems(e) {
		...
		getData: function(data)
		{
			...
			data.sotbit_set_site_template = this.templateSigns;
		...
		setColorFromMultibasket: function()
		{
			...
			const basketTitle = document.querySelector('.multibakset-color-title');
			...
			if (
				...
				colorConteiner.style = `border-top-color: #${currentBasket.COLOR}`;
