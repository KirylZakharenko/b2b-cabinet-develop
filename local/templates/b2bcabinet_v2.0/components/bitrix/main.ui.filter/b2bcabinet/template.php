...
<div class="main-ui-filter-search <?=$filterSearchClass?>" id="<?=$arParams["FILTER_ID"]?>_search_container">
	<input
			...
			class="form-control form-control-sm border-primary main-ui-filter-search-filter"
			id="<?=$arParams["FILTER_ID"]?>_search"
			autocomplete="off">
	<div class="main-ui-item-icon-block">
		<span class="main-ui-item-icon main-ui-search ph-magnifying-glass text-primary">
		</span>
		<span class="main-ui-item-icon main-ui-delete ph-x text-primary fs-base">
		</span>
	</div>
</div>
