...
$propsCompanyName = Option::get("sotbit.auth", "COMPANY_PROPS_NAME_FIELD_" . $arResult["PERSON_TYPE"]["ID"], "", SITE_ID);
                                                    ...
                                                    foreach($block["PROPS"] as $property)
                                                    {
                                                        ...
                                                        <div class="form-group form-group-float<?= ($property["TYPE"] == "CHECKBOX" || $property["TYPE"] == 'Y/N') ? ' form-check' : '' ?>">
                                                            ...
                                                            elseif ($property["TYPE"] == "TEXT"  || $property["TYPE"] == "NUMBER")
                                                            {
                                                                ...
                                                                else
                                                                {
                                                                    ...
                                                                    <input
                                                                            ...
                                                                            maxlength="50"
                                                                            id="sppd-property-<?=$key?>"
                                                                            <?=$propsCompanyName === $property['CODE'] ? 'oninput="changeName()"' : ''?>
                                                                            value="<?=$currentValue?>"/>
                                                                    <?
                                                                }
                                                            }
                                                            ...
                                                            <?
                                                                        ...
                                                                        <div class="sale-personal-profile-detail-form-file d-flex align-items-center gap-3 mb-2">
                                                                            ...
                                                                            if (CFile::IsImage($file['FILE_NAME']))
                                                                            {
                                                                                ...
                                                                                <div class="sale-personal-profile-detail-prop-img rounded-2 overflow-hidden">
                                                                                    <?=CFile::ShowImage($fileId, 78, 78, "border=0", "", true)?>
                                                                                </div>
                                                                                <?
                                                                            }
                                                                            else
                                                                            ...
                                                                            <div class="form-check">
                                                                                <input type="checkbox" value="<?=$fileId?>" class="form-check-input profile-property-check-file" id="profile-property-check-file-<?=$fileId?>">
                                                                                <label class="form-check-label" for="profile-property-check-file-<?=$fileId?>"><?=Loc::getMessage('SPPD_DELETE_FILE')?></label>
                                                                            </div>
                                                                        </div>
                                                                        <?
                                                                    }
                                                                ...
                                                                <div>
                                                                    <?=CFile::InputFile($name."[]", 20, null, false, 0, "IMAGE", "class='form-control border' ".$multiple)?>
                                                                </div>
                                                                <?
                                                            }
...
<script>
    ...
    function changeName() {
        document.querySelector('input[name="NAME"]').value = event.target.value;
    }
</script>
