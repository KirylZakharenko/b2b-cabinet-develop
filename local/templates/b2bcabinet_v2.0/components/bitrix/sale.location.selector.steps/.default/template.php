	...
	<div id="sls-<?=$arResult['RANDOM_TAG']?>" class="bx-slst<?if($arResult['ADMIN_MODE']):?> bx-admin-mode<?endif?>">
		...
		<script type="text/html" data-template-id="bx-ui-slst-selector-scope">
			...
			<div class="dropdown-block bx-ui-slst-input-block<?=($arParams['DISABLE_KEYBOARD_INPUT'] == 'Y' ? ' disabled-keyboard' : '')?>">
				<span class="dropdown-icon form-control-feedback-icon">
				...
				<div class="bx-ui-combobox-loader spinner-grow" data-bx-ui-id="combobox-loader"></div>
				<div class="bx-ui-combobox-toggle" title="<?=Loc::getMessage('SALE_SLS_OPEN_CLOSE_POPUP')?>" data-bx-ui-id="combobox-toggle">
					<i class="ph-caret-down d-block fs-base"></i>	
				</div>
