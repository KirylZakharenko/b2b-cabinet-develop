        ...
        <div class="container-fluid p-0">
            <div class="d-flex d-xl-none me-sm-2 me-0">
                <button type="button" 
                        ...
                        aria-label="<?= Loc::getMessage("HEADER_BTN_MOBILE_MENU") ?>">
                    <i class="ph-list"></i>
                </button>
            ...
            <ul class="nav hstack flex-row justify-content-end order-1 order-lg-2">
                ...
                <? endif; ?>
                <?if (Loader::includeModule("sotbit.multilang")):?>
                    <li id="multilang-choose" class="nav-item nav-user nav-item-dropdown-lg dropdown me-md-2">
                        <?
                        $APPLICATION->IncludeComponent(
                ...
                <? if ($USER->IsAuthorized()) : ?>
                    ...
                    <li class="nav-item cart-header">
                        <div>
                            <select name="" id="currency-choise">
                                <?
                                $currencySelected = CurrencyTable::getList([
                    ...
                    <li class0="nav-item cart-header">
        ...
        <div class="page-header">
            <div class="page-header-content d-lg-flex">
                <div class="d-flex align-items-center flex-wrap justify-content-between w-100">
                    ...
                    <div class="product-inner__stickers flex-grow-1">
